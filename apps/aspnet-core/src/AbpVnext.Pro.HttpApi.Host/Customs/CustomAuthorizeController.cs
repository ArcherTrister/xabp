...
//public class CustomAuthorizeController : AuthorizeController
//{
//    [HttpGet]
//    [HttpPost]
...
//                var identitie = principal.Identities.FirstOrDefault();
//                identitie?.AddClaim(AbpClaimTypes.SessionId, result.Principal.GetClaim(AbpClaimTypes.SessionId));
...
//        if (authorizations.Count == 0 && await ApplicationManager.HasConsentTypeAsync(application, OpenIddictConstants.ConsentTypes.External))
//        {
//            return Forbid(
//                authenticationSchemes: OpenIddictServerAspNetCoreDefaults.AuthenticationScheme,
//                properties: new AuthenticationProperties(new Dictionary<string, string>
