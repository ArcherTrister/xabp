...
/// </summary>
public class CustomDefaultClaimsService : IClaimsService
{
    /// <summary>
    /// The logger
    /// </summary>
    ...
    public CustomDefaultClaimsService(IProfileService profile, ILogger<CustomDefaultClaimsService> logger)
    {
        Logger = logger;
        Profile = profile;
    }
