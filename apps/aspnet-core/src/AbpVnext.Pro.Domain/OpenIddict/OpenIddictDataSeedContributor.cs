...
namespace AbpVnext.Pro.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _scopeManager.FindByNameAsync("Pro") == null)
        {
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        if (!webClientId.IsNullOrWhiteSpace())
        {
            ...
            /* Pro_Web client is only needed if you created a tiered
        ...
        // Blazor Client
        var blazorClientId = configurationSection["Pro_Blazor:ClientId"];
        if (!blazorClientId.IsNullOrWhiteSpace())
        {
            var blazorRootUrl = configurationSection["Pro_Blazor:RootUrl"].TrimEnd('/');
        ...
        var blazorServerTieredClientId = configurationSection["Pro_BlazorServerTiered:ClientId"];
        if (!blazorServerTieredClientId.IsNullOrWhiteSpace())
        {
            var blazorServerTieredRootUrl = configurationSection["Pro_BlazorServerTiered:RootUrl"].EnsureEndsWith('/');
        ...
        // Web Public Client
        var webPublicClientId = configurationSection["Pro_Web_Public:ClientId"];
        if (!webPublicClientId.IsNullOrWhiteSpace())
        {
            var webPublicRootUrl = configurationSection["Pro_Web_Public:RootUrl"].EnsureEndsWith('/');
        ...
        var webPublicTieredClientId = configurationSection["Pro_Web_Public_Tiered:ClientId"];
        if (!webPublicTieredClientId.IsNullOrWhiteSpace())
        {
            var webPublicTieredRootUrl = configurationSection["Pro_Web_Public_Tiered:RootUrl"].EnsureEndsWith('/');
