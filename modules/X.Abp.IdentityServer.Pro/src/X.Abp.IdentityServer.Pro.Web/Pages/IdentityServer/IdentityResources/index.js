(function ($) {
            ...
            return actionList.addManyTail(
                [
                    ...
                    },
                    {
                        ...
                        action: function (data) {
                            x.abp.identityServer.identityResources
    ...
    $(function () {
        ...
        _dataTable = $('#IdentityResourcesTable').DataTable(abp.libs.datatables.normalizeConfiguration({
            ...
            scrollCollapse: true,
            order: [[1, "desc"]],
            ajax: abp.libs.datatables.createAjax(x.abp.identityServer.identityResources.getList,getFilter),
                ...
                function (result) {
                    if (result) {
                        x.abp.identityServer.identityResources
                            ...
                            .then(function () {
                                _dataTable.ajax.reload(null, false);
                                abp.notify.success(l('CreatedStandardIdentityResourcesSuccessfully'));
                            });
                    }
                });
        });
