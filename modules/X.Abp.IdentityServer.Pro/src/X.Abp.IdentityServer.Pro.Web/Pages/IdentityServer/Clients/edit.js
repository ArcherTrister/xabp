        ...
        var initModal = function (publicApi, args) {
            ...
            var getCallbackUriTableRow = function (type) {
                return "<tr>\r\n<td>\r\n" +
                    ...
                    "                                       <button type=\"button\"  class=\"btn btn-danger btn-sm float-end deleteApplicationUriButton\"><i class=\"fa fa-trash\"></i></button>" +
                    "</td></tr>";
            };
            ...
            $(".otherResource").on('click', function (event) {
                ...
                $("#" + groupId).show();
                for (const option of $("#" + groupId + " option")) {
            ...
            var getClaimTableRow = function (type, value) {
                return "<tr>\r\n<td>\r\n" +
                    ...
                    "                                       <button type=\"button\" class=\"btn btn-danger btn-sm float-end deleteClaimButton\"><i class=\"fa fa-trash\"></i></button>" +
                    "</td></tr>";
            }
            ...
            var getGrantTypeTableRow = function (type) {
                return "<tr>\r\n<td>\r\n" +
                    ...
                    "                                       <button type=\"button\" class=\"btn btn-danger btn-sm float-end deleteGrantTypeButton\"><i class=\"fa fa-trash\"></i></button>" +
                    "</td></tr>";
            }
            ...
            var getTableRow = function (type, value, description, expiration) {
                return "<tr>\r\n<td>\r\n" +
                    ...
                    "                                       <button type=\"button\" class=\"btn btn-danger btn-sm float-end deleteSecretButton\"><i class=\"fa fa-trash\"></i></button>" +
                    "</td></tr>";
            }
