(function($) {
                    ...
                    },
                    {
                        ...
                        action: function (data) {
                            _permissionsModal.open({
                                ...
                                providerKeyDisplayName: data.record.clientName
                            });
                        }
                    },
                    {
    ...
    $(function () {
        ...
        _dataTable = $('#ClientsTable').DataTable(abp.libs.datatables.normalizeConfiguration({
            ...
            scrollCollapse: true,
            order: [[1, "desc"]],
            ajax: abp.libs.datatables.createAjax(x.abp.identityServer.clients.getList,getFilter),
