...
IPaymentRequestAppService
{
  ...
  [HttpPost]
  public virtual Task<PaymentRequestWithDetailsDto> CompleteAsync(
  ...
  [HttpPost]
  [Route("requests")]
  public virtual Task<PaymentRequestWithDetailsDto> CreateAsync(
  ...
  public virtual Task<bool> HandleWebhookAsync(
    string paymentGateway,
    string payload,
  ...
  [HttpPost]
  public virtual Task<PaymentRequestStartResultDto> StartAsync(
    string paymentGateway,
