...
public class MongoIdentityRoleRepository : MongoDbRepository<IIdentityProMongoDbContext, IdentityRole, Guid>, IIdentityRoleRepository
{
    public MongoIdentityRoleRepository(IMongoDbContextProvider<IIdentityProMongoDbContext> dbContextProvider)
