...
public class EfCoreIdentityRoleRepository : EfCoreRepository<IIdentityProDbContext, IdentityRole, Guid>, IIdentityRoleRepository
{
    public EfCoreIdentityRoleRepository(IDbContextProvider<IIdentityProDbContext> dbContextProvider)
