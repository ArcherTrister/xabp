...
public class EfCoreIdentityUserRepository : EfCoreRepository<IIdentityProDbContext, IdentityUser, Guid>, IIdentityUserRepository
{
    public EfCoreIdentityUserRepository(IDbContextProvider<IIdentityProDbContext> dbContextProvider)
