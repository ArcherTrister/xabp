...
[Authorize(AbpIdentityProPermissions.OrganizationUnits.Default)]
public class OrganizationUnitAppService : IdentityAppServiceBase, IOrganizationUnitAppService
{
    ...
    [Authorize(AbpIdentityProPermissions.OrganizationUnits.ManageOU)]
    ...
    [Authorize(AbpIdentityProPermissions.OrganizationUnits.ManageRoles)]
    ...
    [Authorize(AbpIdentityProPermissions.OrganizationUnits.ManageUsers)]
