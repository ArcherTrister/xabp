...
using X.Abp.OpenIddict.WildcardDomains;
...
public class AbpOpenIddictProAspNetCoreModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.ViewLocationFormats.Add("/X/Abp/OpenIddict/Views/{1}/{0}.cshtml");
        });
    }
