(function ($) {
    ...
    var _languageAppService = x.abp.languageManagement.language;
    ...
    $(function () {
        ...
        _dataTable = $('#LanguagesTable').DataTable(abp.libs.datatables.normalizeConfiguration({
            ...
            ordering: false,
            searching: false,
            ajax: abp.libs.datatables.createAjax(x.abp.languageManagement.language.getList, getFilter),
        ...
        _createModal.onResult(function () {
            _dataTable.ajax.reload(null, false);
            abp.message.info(l("NewLanguageMightRequireRestartInformation"));
        });
