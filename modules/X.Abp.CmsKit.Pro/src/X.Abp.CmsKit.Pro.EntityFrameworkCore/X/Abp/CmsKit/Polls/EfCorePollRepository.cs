...
IPollRepository
{
    ...
    public async Task<Poll> FindByWidgetAsync(string widget, CancellationToken cancellationToken = default)
    {
        return string.IsNullOrWhiteSpace(widget)
            ? null
    ...
    public async Task<Poll> FindByCodeAsync(string code, CancellationToken cancellationToken = default)
    {
