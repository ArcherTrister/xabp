...
{
    public static void ConfigureCmsKitPro(this IMongoModelBuilder builder)
    {
        ...
        builder.Entity<FaqSection>(x => x.CollectionName = AbpCmsKitDbProperties.DbTablePrefix + "FaqSections");
        builder.Entity<FaqQuestion>(x => x.CollectionName = AbpCmsKitDbProperties.DbTablePrefix + "FaqQuestions");
    }
}
