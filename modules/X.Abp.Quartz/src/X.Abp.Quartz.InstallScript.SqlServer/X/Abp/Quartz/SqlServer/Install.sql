...
CREATE INDEX [IDX_$(TablePrefix)FT_J_G]                ON [dbo].[$(TablePrefix)JOB_HISTORY](SCHED_NAME, JOB_NAME, JOB_GROUP);
CREATE INDEX [IDX_$(TablePrefix)FT_JG]                 ON [dbo].[$(TablePrefix)JOB_HISTORY](SCHED_NAME, JOB_GROUP);
CREATE INDEX [IDX_$(TablePrefix)FT_T_G]                ON [dbo].[$(TablePrefix)JOB_HISTORY](SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP);
CREATE INDEX [IDX_$(TablePrefix)FT_TG]                 ON [dbo].[$(TablePrefix)JOB_HISTORY](SCHED_NAME, TRIGGER_GROUP);
CREATE INDEX [IDX_$(TablePrefix)FT_E]                  ON [dbo].[$(TablePrefix)JOB_HISTORY](SCHED_NAME, ERROR);