...
BEGIN
  ...
  IF EXISTS (SELECT 1 from sys.indexes WHERE name ='IDX_$(TablePrefix)T_J' AND object_id = OBJECT_ID('dbo.$(TablePrefix)TRIGGERS'))
  BEGIN
      DROP INDEX [IDX_$(TablePrefix)T_J] on [dbo].[$(TablePrefix)TRIGGERS]
  END

  IF EXISTS (SELECT 1 from sys.indexes WHERE name ='IDX_$(TablePrefix)T_JG' AND object_id = OBJECT_ID('dbo.$(TablePrefix)TRIGGERS'))
  BEGIN
      DROP INDEX [IDX_$(TablePrefix)T_JG] on [dbo].[$(TablePrefix)TRIGGERS]
  END

  IF EXISTS (SELECT 1 from sys.indexes WHERE name ='IDX_$(TablePrefix)T_C' AND object_id = OBJECT_ID('dbo.$(TablePrefix)TRIGGERS'))
  BEGIN
      DROP INDEX [IDX_$(TablePrefix)T_C] on [dbo].[$(TablePrefix)TRIGGERS]
  END

  IF EXISTS (SELECT 1 from sys.indexes WHERE name ='IDX_$(TablePrefix)T_G' AND object_id = OBJECT_ID('dbo.$(TablePrefix)TRIGGERS'))
  BEGIN
      DROP INDEX [IDX_$(TablePrefix)T_G] on [dbo].[$(TablePrefix)TRIGGERS]
  END

  IF EXISTS (SELECT 1 from sys.indexes WHERE name ='IDX_$(TablePrefix)T_G_J' AND object_id = OBJECT_ID('dbo.$(TablePrefix)TRIGGERS'))
  BEGIN
      DROP INDEX [IDX_$(TablePrefix)T_G_J] on [dbo].[$(TablePrefix)TRIGGERS]
  END

  IF EXISTS (SELECT 1 from sys.indexes WHERE name ='IDX_$(TablePrefix)T_STATE' AND object_id = OBJECT_ID('dbo.$(TablePrefix)TRIGGERS'))
  BEGIN
      DROP INDEX [IDX_$(TablePrefix)T_STATE] on [dbo].[$(TablePrefix)TRIGGERS]
  END

  IF EXISTS (SELECT 1 from sys.indexes WHERE name ='IDX_$(TablePrefix)T_N_STATE' AND object_id = OBJECT_ID('dbo.$(TablePrefix)TRIGGERS'))
  BEGIN
      DROP INDEX [IDX_$(TablePrefix)T_N_STATE] on [dbo].[$(TablePrefix)TRIGGERS]
  END

  IF EXISTS (SELECT 1 from sys.indexes WHERE name ='IDX_$(TablePrefix)T_N_G_STATE' AND object_id = OBJECT_ID('dbo.$(TablePrefix)TRIGGERS'))
  BEGIN
      DROP INDEX [IDX_$(TablePrefix)T_N_G_STATE] on [dbo].[$(TablePrefix)TRIGGERS]
  END

  IF EXISTS (SELECT 1 from sys.indexes WHERE name ='IDX_$(TablePrefix)T_NEXT_FIRE_TIME' AND object_id = OBJECT_ID('dbo.$(TablePrefix)TRIGGERS'))
  BEGIN
      DROP INDEX [IDX_$(TablePrefix)T_NEXT_FIRE_TIME] on [dbo].[$(TablePrefix)TRIGGERS]
  END

  IF EXISTS (SELECT 1 from sys.indexes WHERE name ='IDX_$(TablePrefix)T_NFT_ST' AND object_id = OBJECT_ID('dbo.$(TablePrefix)TRIGGERS'))
  BEGIN
      DROP INDEX [IDX_$(TablePrefix)T_NFT_ST] on [dbo].[$(TablePrefix)TRIGGERS]
  END

  IF EXISTS (SELECT 1 from sys.indexes WHERE name ='IDX_$(TablePrefix)T_NFT_MISFIRE' AND object_id = OBJECT_ID('dbo.$(TablePrefix)TRIGGERS'))
  BEGIN
      DROP INDEX [IDX_$(TablePrefix)T_NFT_MISFIRE] on [dbo].[$(TablePrefix)TRIGGERS]
  END

  IF EXISTS (SELECT 1 from sys.indexes WHERE name ='IDX_$(TablePrefix)T_NFT_ST_MISFIRE' AND object_id = OBJECT_ID('dbo.$(TablePrefix)TRIGGERS'))
  BEGIN
      DROP INDEX [IDX_$(TablePrefix)T_NFT_ST_MISFIRE] on [dbo].[$(TablePrefix)TRIGGERS]
  END

  IF EXISTS (SELECT 1 from sys.indexes WHERE name ='IDX_$(TablePrefix)T_NFT_ST_MISFIRE_GRP' AND object_id = OBJECT_ID('dbo.$(TablePrefix)TRIGGERS'))
  BEGIN
      DROP INDEX [IDX_$(TablePrefix)T_NFT_ST_MISFIRE_GRP] on [dbo].[$(TablePrefix)TRIGGERS]
  END

  IF EXISTS (SELECT 1 from sys.indexes WHERE name ='IDX_$(TablePrefix)FT_TRIG_INST_NAME' AND object_id = OBJECT_ID('dbo.$(TablePrefix)FIRED_TRIGGERS'))
  BEGIN
      DROP INDEX [IDX_$(TablePrefix)FT_TRIG_INST_NAME] on [dbo].[$(TablePrefix)FIRED_TRIGGERS]
  END

  IF EXISTS (SELECT 1 from sys.indexes WHERE name ='IDX_$(TablePrefix)FT_INST_JOB_REQ_RCVRY' AND object_id = OBJECT_ID('dbo.$(TablePrefix)FIRED_TRIGGERS'))
  BEGIN
      DROP INDEX [IDX_$(TablePrefix)FT_INST_JOB_REQ_RCVRY] on [dbo].[$(TablePrefix)FIRED_TRIGGERS]
  END

  IF EXISTS (SELECT 1 from sys.indexes WHERE name ='IDX_$(TablePrefix)FT_J_G' AND object_id = OBJECT_ID('dbo.$(TablePrefix)FIRED_TRIGGERS'))
  BEGIN
      DROP INDEX [IDX_$(TablePrefix)FT_J_G] on [dbo].[$(TablePrefix)FIRED_TRIGGERS]
  END

  IF EXISTS (SELECT 1 from sys.indexes WHERE name ='IDX_$(TablePrefix)FT_JG' AND object_id = OBJECT_ID('dbo.$(TablePrefix)FIRED_TRIGGERS'))
  BEGIN
      DROP INDEX [IDX_$(TablePrefix)FT_JG] on [dbo].[$(TablePrefix)FIRED_TRIGGERS]
  END

  IF EXISTS (SELECT 1 from sys.indexes WHERE name ='IDX_$(TablePrefix)FT_T_G' AND object_id = OBJECT_ID('dbo.$(TablePrefix)FIRED_TRIGGERS'))
  BEGIN
      DROP INDEX [IDX_$(TablePrefix)FT_T_G] on [dbo].[$(TablePrefix)FIRED_TRIGGERS]
  END

  IF EXISTS (SELECT 1 from sys.indexes WHERE name ='IDX_$(TablePrefix)FT_TG' AND object_id = OBJECT_ID('dbo.$(TablePrefix)FIRED_TRIGGERS'))
  BEGIN
      DROP INDEX [IDX_$(TablePrefix)FT_TG] on [dbo].[$(TablePrefix)FIRED_TRIGGERS]
  END

  IF EXISTS (SELECT 1 from sys.indexes WHERE name ='IDX_$(TablePrefix)FT_G_J' AND object_id = OBJECT_ID('dbo.$(TablePrefix)FIRED_TRIGGERS'))
  BEGIN
      DROP INDEX [IDX_$(TablePrefix)FT_G_J] on [dbo].[$(TablePrefix)FIRED_TRIGGERS]
  END

  IF EXISTS (SELECT 1 from sys.indexes WHERE name ='IDX_$(TablePrefix)FT_G_T' AND object_id = OBJECT_ID('dbo.$(TablePrefix)FIRED_TRIGGERS'))
  BEGIN
      DROP INDEX [IDX_$(TablePrefix)FT_G_T] on [dbo].[$(TablePrefix)FIRED_TRIGGERS]
  END
