...
-- CREATE DATABASE quartznet CHARACTER SET utf8 COLLATE utf8_general_ci;
...
CREATE TABLE $(TablePrefix)JOB_HISTORY (
...
JOB_GROUP VARCHAR(150) NULL DEFAULT NULL,
...
CREATE INDEX IDX_$(TablePrefix)FT_J_G ON $(TablePrefix)JOB_HISTORY(SCHED_NAME, JOB_NAME, JOB_GROUP);
CREATE INDEX IDX_$(TablePrefix)FT_JG ON $(TablePrefix)JOB_HISTORY(SCHED_NAME, JOB_GROUP);
CREATE INDEX IDX_$(TablePrefix)FT_T_G ON $(TablePrefix)JOB_HISTORY(SCHED_NAME, TRIGGER_NAME, TRIGGER_GROUP);
CREATE INDEX IDX_$(TablePrefix)FT_TG ON $(TablePrefix)JOB_HISTORY(SCHED_NAME, TRIGGER_GROUP);
CREATE INDEX IDX_$(TablePrefix)FT_E ON $(TablePrefix)JOB_HISTORY(SCHED_NAME, ERROR);
