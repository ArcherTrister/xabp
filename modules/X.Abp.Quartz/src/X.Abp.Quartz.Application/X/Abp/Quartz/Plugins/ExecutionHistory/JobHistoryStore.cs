...
public class JobHistoryStore
{
    ...
    public async Task CreateJobHistoryEntryAsync(
    ...
    /*
            ...
            //public async Task UpdateJobHistoryEntryErrorAsync(
            //    IJobExecutionContext context,
            //    JobExecutionException jobException,
            //    CancellationToken cancellationToken = default)
            //{
            ...
            //public async Task UpdateJobHistoryEntryVetoedAsync(
            //    IJobExecutionContext context,
            //    CancellationToken cancellationToken = default)
            //{
            //    if (Provider.Equals("InMemory", StringComparison.OrdinalIgnoreCase))
    ...
    /*
            //public async Task<long> GetAllCountAsync(string schedulerName, CancellationToken cancellationToken = default)
            //{
            //    if (Provider.Equals("InMemory", StringComparison.OrdinalIgnoreCase))
            //    {
    ...
    */
    ...
    public async Task<ExecutionHistoryDto> GetJobHistoryEntryAsync(long entryId, CancellationToken cancellationToken = default)
    {
        if (Provider.Equals("InMemory", StringComparison.OrdinalIgnoreCase))
        {
...
"WHERE 1=1 AND SCHED_NAME = @schedulerName AND RowNumber BETWEEN @page AND @endPage";
    ...
    public async Task<PagedResultDto<ExecutionHistoryDto>> GetPageJobHistoryEntriesAsync(
    ...
    //public async Task<IEnumerable<ExecutionHistoryEntry>> FilterLastOfEveryJobAsync(string schedulerName, int limitPerJob, CancellationToken cancellationToken = default)
    //{
    ...
    //public async Task<IEnumerable<ExecutionHistoryEntry>> FilterLastOfEveryTriggerAsync(string schedulerName, int limitPerTrigger, CancellationToken cancellationToken = default)
    //{
    //    List<ExecutionHistoryEntry> list = new List<ExecutionHistoryEntry>();
    //    if (Provider.Equals("InMemory", StringComparison.OrdinalIgnoreCase))
    //    {
    ...
    //public async Task<IEnumerable<ExecutionHistoryEntry>> FilterLastAsync(string schedulerName, int limit, CancellationToken cancellationToken = default)
    //{
    //    List<ExecutionHistoryEntry> list = new List<ExecutionHistoryEntry>();
    //    if (Provider.Equals("InMemory", StringComparison.OrdinalIgnoreCase))
    //    {
    ...
    //public async Task<long> GetTotalJobsExecutedAsync(string schedulerName, CancellationToken cancellationToken = default)
    //{
    //    if (Provider.Equals("InMemory", StringComparison.OrdinalIgnoreCase))
    //    {
    ...
    //public async Task<long> GetTotalJobsFailedAsync(string schedulerName, CancellationToken cancellationToken = default)
    //{
    //    if (Provider.Equals("InMemory", StringComparison.OrdinalIgnoreCase))
    //    {
    ...
    //}
    */
    public async Task PurgeAsync(string schedulerName, CancellationToken cancellationToken = default)
    {
        if (Provider.Equals("InMemory", StringComparison.OrdinalIgnoreCase))
        {
