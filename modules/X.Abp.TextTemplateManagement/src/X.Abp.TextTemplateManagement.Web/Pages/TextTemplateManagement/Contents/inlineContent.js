$(function () {
    ...
    var templateContentsService = window.x.abp.textTemplateManagement.textTemplates.templateContent;
    ...
    $('#edit-unique-localization').click(function () {
        window.location = "/TextTemplateManagement/Contents/" + getTemplateDefinitionName();
    });
});
