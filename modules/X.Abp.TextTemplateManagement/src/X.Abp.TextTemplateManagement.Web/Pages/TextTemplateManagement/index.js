(function ($) {
    ...
    var templateDefinitionService = window.x.abp.textTemplateManagement.textTemplates.templateDefinition;
                ...
                [
                    {
                        ...
                        action: function (data) {
                            if (data.record.isInlineLocalized) {
                                window.location = "TextTemplateManagement/Contents/InlineContent/" + data.record.name;
                            } else {
                                window.location = "TextTemplateManagement/Contents/" + data.record.name;
                            }
                        }
                    }
                ]
