...
/// </summary>
public class BulkExtensionsSqlServerEfCoreBulkOperationProvider
    : IEfCoreBulkOperationProvider, ITransientDependency
{
    protected IAuditPropertySetter AuditPropertySetter { get; }

    public BulkExtensionsSqlServerEfCoreBulkOperationProvider(IAuditPropertySetter auditPropertySetter)
    {
