...
/// </summary>
public class BulkExtensionsMySqlEfCoreBulkOperationProvider
    : IEfCoreBulkOperationProvider, ITransientDependency
{
  protected IAuditPropertySetter AuditPropertySetter { get; }

  public BulkExtensionsMySqlEfCoreBulkOperationProvider(IAuditPropertySetter auditPropertySetter)
  {
