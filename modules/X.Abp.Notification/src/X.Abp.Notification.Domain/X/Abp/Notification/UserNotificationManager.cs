...
namespace X.Abp.Notification
{
    ...
    public class UserNotificationManager : IUserNotificationManager, ISingletonDependency
    {
        ...
        public async Task<List<UserNotificationInfo>> GetUserNotificationsAsync(UserIdentifier user, UserNotificationState? state = null, string notificationName = null, int skipCount = 0, int maxResultCount = int.MaxValue, DateTime? startDate = null, DateTime? endDate = null)
        {
