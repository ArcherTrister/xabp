...
namespace X.Abp.Notification
{
  ...
  public class UserNotificationSubscriptionManager : IUserNotificationSubscriptionManager, ITransientDependency
  {
    ...
    public virtual async Task UnSubscribeAsync(UserIdentifier user, string notificationName, EntityIdentifier entityIdentifier = null)
    {
    ...
    public virtual async Task<List<UserNotificationSubscriptionInfo>> GetSubscriptionsAsync(string notificationName, EntityIdentifier entityIdentifier = null, string[] targetNotifiers = null)
    {
