...
abp generate-proxy -t js -url https://localhost:44302/ -m cms-kit-pro -wd ./modules/X.Abp.CmsKit.Pro/src/X.Abp.CmsKit.Pro.Public.HttpApi.Client -o ../X.Abp.CmsKit.Pro.Public.Web/wwwroot/client-proxies/
...
abp generate-proxy -t js -url https://localhost:44302/ -m leptonTheme -wd ./modules/X.Abp.LeptonTheme/src/X.Abp.LeptonTheme.Management.HttpApi.Client -o ../X.Abp.LeptonTheme.Management.Web/wwwroot/client-proxies/
...
ECHO.
ECHO.js-proxy have been successfully generate. Press any key to exit.
pause > nul
