...
& abp generate-proxy -t csharp -url https://localhost:44302/ -m cms-kit-pro-common -wd ./modules/X.Abp.CmsKit.Pro/src/X.Abp.CmsKit.Pro.Public.HttpApi.Client --without-contracts --folder ClientProxies
...
# & abp generate-proxy -t csharp -url https://localhost:44302/ -m leptonThemeManagement -wd ./modules/X.Abp.LeptonTheme/src/X.Abp.LeptonTheme.Management.HttpApi.Client --without-contracts --folder ClientProxies
...
# 输出完成信息
Write-Host ""
Write-Host "CSharp proxies have been successfully generated."
