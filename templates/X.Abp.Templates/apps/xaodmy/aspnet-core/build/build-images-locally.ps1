...
docker build -f Dockerfile.local -t MyCompanyName.MyProjectName-db-migrator:$version .
...
dotnet publish -c Release
docker build -f Dockerfile.local -t MyCompanyName.MyProjectName-service-identity:$version .

### ADMINISTRATION-SERVICE
Write-Host "*** BUILDING ADMINISTRATION-SERVICE ***" -ForegroundColor Green
Set-Location $administrationServiceFolder
dotnet publish -c Release
docker build -f Dockerfile.local -t MyCompanyName.MyProjectName-service-administration:$version .

### SAAS-SERVICE
Write-Host "*** BUILDING SAAS-SERVICE ***" -ForegroundColor Green
Set-Location $saasServiceFolder
dotnet publish -c Release
docker build -f Dockerfile.local -t MyCompanyName.MyProjectName-service-saas:$version .

### PRODUCT-SERVICE
Write-Host "*** BUILDING PRODUCT-SERVICE ***" -ForegroundColor Green
Set-Location $productServiceFolder
dotnet publish -c Release
docker build -f Dockerfile.local -t MyCompanyName.MyProjectName-service-product:$version .
...
dotnet publish -c Release
docker build -f Dockerfile.local -t MyCompanyName.MyProjectName-gateway-web:$version .

### PUBLICWEB-GATEWAY
Write-Host "*** BUILDING WEB-PUBLIC-GATEWAY ***" -ForegroundColor Green
Set-Location $webPublicGatewayFolder
dotnet publish -c Release
docker build -f Dockerfile.local -t MyCompanyName.MyProjectName-gateway-web-public:$version .
...
dotnet publish -c Release
docker build -f Dockerfile.local -t MyCompanyName.MyProjectName-app-authserver:$version .

### PUBLIC-WEB
Write-Host "*** BUILDING WEB-PUBLIC ***" -ForegroundColor Green
Set-Location $publicWebFolder
dotnet publish -c Release
docker build -f Dockerfile.local -t MyCompanyName.MyProjectName-app-public-web:$version .
### MVC WEB App
if (Test-Path -Path $mvcAppFolder) {
    Write-Host "*** BUILDING MVC WEB APPLICATION ***" -ForegroundColor Green
    Set-Location $mvcAppFolder
    dotnet publish -c Release
    docker build -f Dockerfile.local -t MyCompanyName.MyProjectName-app-web:$version .
}
