...
public class IdentityServerDataSeeder : IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateClientsAsync()
    {
        ...
        var blazorClientRootUrl =
            _configuration["IdentityServer:Clients:MyProjectName_Blazor:RootUrl"].EnsureEndsWith('/');
        await CreateClientAsync(
        ...
        var blazorServerClientRootUrl = _configuration["IdentityServer:Clients:MyProjectName_BlazorServer:RootUrl"]
            .EnsureEndsWith('/');
        await CreateClientAsync(
